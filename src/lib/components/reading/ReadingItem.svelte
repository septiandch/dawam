...
<article id={entry.slug} class="mb-6 scroll-mt-25" aria-labelledby={entry.id + '-title'}>
  <Card.Root
    class="gap-0 overflow-visible rounded-2xl border p-5 shadow-none ring-0 md:px-7.5 md:py-7"
  >
    <div class="flex items-center gap-3">
      <Badge
        variant="secondary"
        class="size-8 shrink-0 justify-center rounded-full p-0 text-[11px]"
      >
